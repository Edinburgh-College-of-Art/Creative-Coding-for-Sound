...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 151.0, 390.0, 150.0, 24.0 ],
					"text" : "Decode 2-byte data"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 437.0, 177.0, 150.0, 24.0 ],
					"text" : "Poll Arduino For Data"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 417.0, 50.0, 22.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 76.0, 399.0, 20.0 ],
					"text" : "See the simple-analog-ble.ino sketch for what is happening in the Arduino"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Get a 2-byte sensor value over BLE"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 1.0, 415.0, 47.0 ],
					"text" : "Arduino Sensor over BLE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 411.0, 247.5, 166.0, 22.0 ],
					"text" : "connect name ArduinoSensor"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 411.0, 177.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 411.0, 215.5, 56.0, 22.0 ],
					"text" : "metro 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 64.0, 390.0, 81.0, 22.0 ],
					"text" : "byte-cast uh<"
				}
